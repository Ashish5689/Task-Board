          ...
          {isEditing && (
            <div className="absolute -bottom-1 -right-1 flex space-x-1">
              <button
                ...
                className="bg-indigo-600 text-white rounded-full p-2 shadow-md hover:bg-indigo-700 transition-colors duration-200"
                title="Upload photo"
              >
              ...
              {previewUrl && (
                <button
                  ...
                  className="bg-red-600 text-white rounded-full p-2 shadow-md hover:bg-red-700 transition-colors duration-200"
                  title="Remove photo"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
